...
export async function execute(this: IExecuteFunctions, i: number) {
	...
	const setFilePropertiesResponse = await setFileProperties(this, i, fileProperties, objectData);
	if (!setFilePropertiesResponse.success) return setFilePropertiesResponse.data;
	...
	const response = await processFileResponse(this, fileProperties, createLimeobjectResponse.data);
